(function() {
    ...
    function oa(a, b, c) {
        ...
        if (typeof b == "string")if (T(c))a[e](b, c); else {
    ...
    function Ea(a, b, c, d, e) {
        ...
        b && R(a, b);
        e && Oa(a, {padding:0,border:fb,margin:0});
        c && Oa(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function kd(a, b) {
        function c(m,
                    ...
                    if (q) {
                        ...
                        if (s.isCartesian) {
                            o(s.data, function(B) {
                                var I = B.x,fa = B.y;
                                if (G === null)G = N = B[nb];
                                if (M)if (I > N)N = I; else {
                                    if (I < G)G = I
                                } else if (T(fa)) {
                                    if (y)C[I] =
                                          C[I] ? C[I] + fa : fa;
                                    B = C ? C[I] : fa;
                                    if (!fc)if (B > N)N = B; else if (B < G)G = B;
                                    if (y)ab[s.type][I] = {total:B,cum:B}
                                }
                            });
            ...
            function J(k, q, s) {
                if (s) {
                    ...
                    I || P.path(P.crispLine([bb,
                        k,y,Ja,C,B], s)).attr({stroke:q,"stroke-width":s}).add(Q)
                }
            }
            ...
            function E(k, q, s, y, C, B, I) {
                ...
                y && P.path(P.crispLine([bb,q,fa,Ja,qb,da], y)).attr({stroke:s,"stroke-width":y}).add(p);
                if (B && Wa.enabled)if ((k = ld.call({index:I,isFirst:k == ea[0],isLast:k == ea[ea.length - 1],dateTimeLabelFormat:gc,
                    value:Qa && Qa[k] ? Qa[k] : k})) || k === 0) {
            ...
            function ma(k, q) {
                ...
                if (!q) {
                    q = [1,2,2.5,5,10];
                    if (h.allowDecimals === false)if (vb == 1)q = [1,2,5,10]; else if (vb <= 0.1)q = [1 / vb]
                }
            ...
            function ua() {
                ea = [];
                var k,q = va.global.useUTC,s = 1E3 / cb,y = 6E4 / cb,C = 36E5 / cb,B = 864E5 / cb,I =
                        6048E5 / cb,fa = 2592E6 / cb,qb = 31556952E3 / cb,da = [["second",s,[1,2,5,10,15,30]],["minute",y,[1,2,5,10,15,30]],["hour",C,[1,2,3,4,6,8,12]],["day",B,[1,2]],["week",I,[1,2]],["month",fa,[1,2,3,4,6]],["year",qb,null]],Wa = da[6],ia = Wa[1],ba = Wa[2];
                ...
                if (ia >= s)ba.setSeconds(ia >= y ? 0 : da * ib(ba.getSeconds() /
                                                                da));
                ...
                for (C = ba[Qb](); s < Y && k < wa;) {
                    ea.push(s);
                    if (ia == qb)s = $b(wb + k * da, 0) / cb; else if (ia == fa)s = $b(wb, y + k * da) / cb; else if (!q && (ia == B || ia == I))s = $b(wb, y, C + k * da * (ia == B ? 1 : 7)); else s += ia * da;
                    k++
                }
                ea.push(s);
            ...
            function xa() {
                jb ? ua() : Ga();
                var k = ea[0],q = ea[ea.length - 1];
                if (h.startOnTick)O = k; else O > k && ea.shift();
                if (h.endOnTick)Y = q; else Y < q && ea.pop()
            }

            function ya() {
                if (!jb && !Qa) {
                    var k = Nb,q = ea.length;
                    Nb = Ob[nb];
                    if (q < Nb) {
                        for (; ea.length < Nb;)ea.push(ja(ea[ea.length - 1] + Ra));
                        hb *= (q - 1) / (Nb - 1)
                    }
                    if (T(k) && Nb != k)V.isDirty =
                                        true
                }
            }
            ...
            function db() {
                ...
                zc = h.minorTickInterval ===
                     "auto" && Ra ? Ra / 5 : h.minorTickInterval;
                xa();
                hb = Pa / (Y - O || 1);
                Ob || (Ob = {x:0,y:0});
            ...
            function Ha(k, q, s) {
                s = z(s, true);
                za(V, "setExtremes", {min:k,max:q}, function() {
                    if (Qa) {
                        if (k < 0)k = 0;
            ...
            function Ya() {
                return{min:O,max:Y,dataMin:G,dataMax:N}
            }

            function rb(k) {
                if (O > k)k = O; else if (Y < k)k = Y;
                return w(k, 0, 1)
            }
            ...
            function t() {
                var k = h.title,q = h.alternateGridColor,s = h.minorTickWidth,y = h.lineWidth,C,B;
                C = U.length && T(O) && T(Y);
                if (p) {
                    p.empty();
                    Q.empty()
                } else {
                    p = P.g("axis").attr({zIndex:7}).add();
                    Q = P.g("grid").attr({zIndex:1}).add()
                }
                if (C || yc) {
                    ...
                    if (zc && !Qa)for (C = O; C <= Y; C += zc) {
                        ...
                        s && E(C, h.minorTickPosition,
                                h.minorTickColor, s, h.minorTickLength)
                    }
                    o(ea, function(I, fa) {
                        B = I + Fb;
                ...
                if (!V.hasRenderedLine && y) {
                    s = aa + (ha ? wa : 0) + Xa;
                    C = Fa - Eb - (ha ? pa : 0) + Xa;
                    P.path(P.crispLine([bb,X ? aa : s,X ? C : ga,Ja,X ? Va - wc : s,X ? C : Fa - Eb], y)).attr({stroke:h.lineColor,"stroke-width":y,zIndex:7}).add();
                    V.hasRenderedLine = true
                }
                if (!V.hasRenderedTitle && !V.axisTitle &&
                    k && k.text) {
                    y = X ? aa : ga;
                    y = {low:y + (X ? 0 : Pa),middle:y + Pa / 2,high:y + (X ? Pa : 0)}[k.align];
                    s = (X ? ga + pa : aa) + (X ? 1 : -1) * (ha ? -1 : 1) * k.margin - (Zb ? parseInt(k.style.fontSize || 12, 10) / 3 : 0);
                    V.axisTitle = P.text(k.text, (X ? y : s + (ha ? wa : 0) + Xa) + (k.x || 0), (X ? s - (ha ? pa : 0) + Xa : y) + (k.y || 0), k.style, k.rotation || 0, {low:"left",middle:"center",high:"right"}[k.align]).attr({zIndex:7}).add();
            ...
            var M = h.isX,ha = h.opposite,X = na ? !M : M,ab = {bar:{},column:{},area:{},areaspline:{},line:{}};
            h = la(M ? hc : Cc, X ? ha ? nd : Yc : ha ? od : pd, h);
            var V = this,jb = h.type == "datetime",Xa = h.offset || 0,nb = M ? "x" : "y",Pa = X ? wa : pa,hb,Db = X ? aa : Eb,p,Q,G,N,U,Ba,Rb,Y = null,O = null,Wc = h.minPadding,Xc = h.maxPadding,yc = T(h.linkedTo),Uc,Vc,fc,Zc = h.events,Dc,Bc = h.plotBands ||
                                                                                                                                                                                                                                                      [],Ac = h.plotLines || [],Ra,zc,vb,ea,Nb,gc,ld = h.labels.formatter || function() {
                var k = this.value;
                return gc ? ic(gc, k) : k
            ...
            ha || (Xa *= -1);
            if (X)Xa *= -1;
            R(V, {addPlotBand:ca,addPlotLine:ca,adjustTickAmount:ya,categories:Qa,getExtremes:Ya,getThreshold:rb,isXAxis:M,options:h,render:t,setExtremes:Ha,setScale:db,setCategories:S,translate:w,redraw:D,removePlotBand:v,removePlotLine:v,reversed:Cb,stacks:ab});
        ...
        function d() {
            function m(w, J, K, E) {
                if (!r[w]) {
                    J = P.text(J, aa + wa - 20, ga + 30, a.toolbar.itemStyle, 0, "right").on("click", E).attr({zIndex:20}).add();
                    r[w] = J
                }
            }
        ...
        function e(m) {
            function h(ca, t) {
                ...
                db = ja ? t : (db + t) / 2;
                Ha.translate(ya, db);
                Ec = $a(ca - ya) > 1 || $a(t - db) > 1 ? function() {
                    h(ca, t)
                } : null
            }
            ...
            function w(ca) {
                var t = ca.series,v = m.borderColor || ca.color || t.color || "#606060",
                        D,S;
                S = ca.tooltipText;
                D = ca.tooltipPos;
                J = t;
                ...
                if (S === false || !D)r(); else {
                    ...
                    Ga = S.width;
                    xa = S.height;
                    Ya.attr({width:Ga + 2 * ma,height:xa + 2 * ma,stroke:v});
                    v = t - Ga + aa - 25;
                    t = ca - xa + ga + 10;
                    if (v < 7) {
                        v = 7;
                    ...
                    if (t < 5)t = 5; else if (t + xa > Fa)t = Fa - xa - 5;
                    h(W(v - ua), W(t - ua))
                }
            }

            var J,K = m.borderWidth,E = m.style,ma = parseInt(E.padding, 10),ua = K + ma,ja = true,Ga,xa,ya = 0,db = 0;
            E.padding = 0;
            var Ha = P.g("tooltip").attr({zIndex:8}).add(),
                    Ya = P.rect(ua, ua, 0, 0, m.borderRadius, K).attr({fill:m.backgroundColor,"stroke-width":K}).add(Ha).shadow(m.shadow),rb = P.text("", ma + ua, parseInt(E.fontSize, 10) + ma + ua).attr({zIndex:1}).css(E).add(Ha);
            return{refresh:w,hide:r}
        }
        ...
        function f(m, h) {
            ...
            function w(t) {
                ...
                {xAxis:[],yAxis:[]};
                o(Sa, function(D) {
                    var S = D.translate,M = D.isXAxis,ha = na ? !M : M;
                    v[M ? "xAxis" : "yAxis"].push({axis:D,value:S(ha ? t.chartX - aa : pa - t.chartY + ga, true)})
                });
                return v
            }

            function J(t) {
                var v = m.hoverPoint,D = m.hoverSeries;
                if (D && D.tracker)(t = D.tooltipPoints[na ? t.chartY : t.chartX - aa]) && t != v && t.onMouseOver()
            }

            function K() {
                var t = m.hoverSeries,v = m.hoverPoint;
                v && v.onMouseOut();
                t && t.onMouseOut();
                Fc && Fc.hide()
            }
            ...
            function E() {
                if (ya) {
                    var t = {xAxis:[],yAxis:[]},v = ya.getBBox(),D = v.x - aa,S = v.y - ga;
                    if (xa) {
                        o(Sa, function(M) {
                            var ha =
                                    M.translate,X = M.isXAxis,ab = na ? !X : X,V = ha(ab ? D : pa - S - v.height, true);
                            ha = ha(ab ? D + v.width : pa - S, true);
                            t[X ? "xAxis" : "yAxis"].push({axis:M,min:Mb(V, ha),max:ub(V, ha)})
                        });
                        za(m, "selection", t, Gc)
                    }
                    ya = ya.destroy()
            ...
            function ma() {
                ...
                Aa.onmousedown = function(v) {
                    ...
                    ja = v.chartX;
                    Ga = v.chartY;
                    if (jc && (Ha || Ya))ya || (ya = P.rect(aa, ga, rb ? 1 : wa, ca ? 1 : pa, 0).attr({fill:"rgba(69,114,167,0.25)",zIndex:7}).add())
                };
                Aa.onmousemove = function(v) {
                    v =
                    r(v);
                    v.returnValue = false;
                    var D = v.chartX,S = v.chartY,M = !Sb(D - aa, S - ga);
                    if (Hc) {
                        xa = Math.sqrt(Math.pow(ja - D, 2) + Math.pow(Ga - S, 2)) > 10;
                        if (rb) {
                            v = D - ja;
                            ya.attr({width:$a(v),x:(v > 0 ? 0 : v) + ja})
                        }
                        if (ca) {
                            S = S - Ga;
                            ya.attr({height:$a(S),y:(S > 0 ? 0 : S) + Ga})
                        }
                    } else M || J(v);
                    if (M && !t) {
                        K();
                ...
                Aa.onclick = function(v) {
                    ...
                    if (!xa)if (D && oa(v.target, "isTracker")) {
                        var S = D.plotX,M = D.plotY;
                        R(D, {pageX:Tb.x + aa + (na ? wa - M : S),pageY:Tb.y + ga + (na ? pa - S : M)});
                        za(m.hoverSeries || D.series, "click", R(v, {point:D}));
            ...
            function ua() {
                ...
                na && Ic.attr({width:m.plotWidth,height:m.plotHeight}).invert();
                Ic.attr({zIndex:9}).translate(aa, ga).add()
            }

            var ja,Ga,xa,ya,db = H.zoomType,Ha = /x/.test(db),Ya = /y/.test(db),rb = Ha && !na || Ya && na,ca = Ya && !na || Ha && na;
            ua();
            ...
            R(this, {zoomX:Ha,zoomY:Ya,
                resetTracker:K})
        }

        function g(m) {
            var h = m.type || H.defaultSeriesType,r = eb[h],w = x.hasRendered;
            if (w)if (na && h == "column")r = eb.bar; else if (!na && h == "bar")r = eb.column;
            h = new r;
            h.init(x, m);
        ...
        function j(m, h) {
            var r;
            h = z(h, true);
            za(x, "addSeries", {options:m}, function() {
                r = g(m);
                r.isDirty = true;
                x.isDirty = true;
                h && x.redraw()
        ...
        function n(m) {
            var h = a.loading;
            if (!xb) {
                xb = Ea(Bb, {className:"highcharts-loading"}, R(h.style, {left:aa + Ca,top:ga + Ca,width:wa + Ca,height:pa + Ca,zIndex:10,display:fb}), Aa);
                Ea("span", null, h.labelStyle, xb)
            }
            if (!Kc) {
                Oa(xb, {opacity:0,display:""});
                xb.getElementsByTagName("span")[0].innerHTML = m || a.lang.loading;
                Ub(xb, {opacity:h.style.opacity}, {duration:h.showDuration});
                Kc = true
            }
        }

        function u() {
            Ub(xb, {opacity:0}, {duration:a.loading.hideDuration,complete:function() {
                Oa(xb, {display:fb})
            }});
            Kc = false
        }
        ...
        function Z() {
            var m = a.title,h = m.align,r = a.subtitle,w = r.align,J = {left:0,center:Va / 2,right:Va};
            m && m.text && P.text(m.text, J[h] + m.x, m.y, m.style, 0, h).attr({"class":"highcharts-title"}).add();
            r && r.text && P.text(r.text, J[w] + r.x, r.y, r.style, 0, w).attr({"class":"highcharts-subtitle"}).add()
        }
        ...
        function Ia() {
            ...
            if (!mb.offsetWidth) {
                yb = mb.cloneNode(0);
                Oa(yb, {position:Vb,top:"-9999px",display:""});
            ...
            x.plotLeft = aa;
            x.plotTop = ga;
            x.container = Aa = Ea(Bb, {className:"highcharts-container" + (H.className ? " " + H.className : ""),id:ad}, R({position:bd,overflow:zb,width:Va + Ca,height:Fa + Ca,textAlign:"left"}, H.style), yb ||
                                                                                                                                                                                                              mb);
            x.renderer = P = H.renderer == "SVG" ? new Wb(Aa, Va, Fa) : new cd(Aa, Va, Fa)
        }

        function sb() {
            var m,h = a.labels,r = a.credits,w = H.borderWidth || 0,J = H.backgroundColor,K = H.plotBackgroundColor,E = H.plotBackgroundImage;
            m = 2 * w + (H.shadow ? 8 : 0);
            if (w || J)P.rect(m / 2, m / 2, Va - m, Fa - m, H.borderRadius, w).attr({stroke:H.borderColor,"stroke-width":w,fill:J || fb}).add().shadow(H.shadow);
            K && P.rect(aa, ga, wa, pa, 0).attr({fill:K}).add().shadow(H.plotShadow);
            E && P.image(E, aa, ga, wa, pa).add();
            H.plotBorderWidth && P.rect(aa, ga, wa, pa, 0, H.plotBorderWidth).attr({stroke:H.plotBorderColor,
                "stroke-width":H.plotBorderWidth,zIndex:4}).add();
            jc && o(Sa, function(ma) {
                ma.render()
            });
            Z();
            h.items && o(h.items, function() {
                var ma = R(h.style, this.style),ua = parseInt(ma.left, 10) + aa,ja = parseInt(ma.top, 10) + ga + 12;
                delete ma.left;
                delete ma.top;
                P.text(this.html, ua, ja, ma).attr({zIndex:2}).add()
            });
            o(ta, function(ma) {
                ma.render()
            });
        ...
        a = la(va, a);
        var H = a.chart,La = H.margin;
        La = typeof La == "number" ? [La,La,La,La] : La;
        var ga = z(H.marginTop, La[0]),wc = z(H.marginRight, La[1]),Eb = z(H.marginBottom, La[2]),aa = z(H.marginLeft, La[3]),mb,yb,Aa,ad,Va,Fa,x = this;
        La = H.events;
        var Mc,Nc,Sb,Fc,Hc,xb,Kc,
                pa,wa,rd,sd,Pb,Ic,Jc,Tb,jc = H.showAxes,Sa = [],Ob,ta = [],na,P,Ec,$c,Gc,dd,qd = function(m) {
            function h(p, Q) {
                var G = p.legendItem,N = p.legendLine,U = p.legendSymbol,Ba = Ha.color,Rb = Q ? E.itemStyle.color : Ba;
                p = Q ? p.color : Ba;
                G && G.css({color:Rb});
                N && N.attr({stroke:p});
                U && U.attr({stroke:p,fill:p})
            }

            function r(p, Q, G) {
                var N = p.legendItem,U = p.legendLine,Ba = p.legendSymbol;
                p = p.checkbox;
                N && N.attr({x:Q,y:G});
                U && U.translate(Q, G - 4);
                Ba && Ba.translate(Q, G);
            ...
            function w(p) {
                for (var Q = Ga.length,G = p.checkbox; Q--;)if (Ga[Q] ==
                                                                p) {
                    Ga.splice(Q, 1);
                    break
                }
            ...
            function J(p) {
                ...
                if (!N) {
                    ...
                    p.legendItem = N = P.text(E.labelFormatter.call(p), 0, 0).css(p.visible ? ya : Ha).on("mouseover", function() {
                        ...
                        var U = "legendItemClick",Ba = function() {
                            p.setVisible()
                        };
                        p.firePointEvent ?
                        p.firePointEvent(U, null, Ba) : za(p, U, null, Ba)
                    }).attr({zIndex:2}).add(V);
                    if (!G && p.options && p.options.lineWidth)p.legendLine = P.path([bb,-ua - ja,0,Ja,-ja,0]).attr({"stroke-width":p.options.lineWidth,zIndex:2}).add(V);
                    if (G)Q = P.rect(-ua - ja, -11, ua, 12, 2).attr({"stroke-width":0,zIndex:3}).add(V); else if (p.options && p.options.marker && p.options.marker.enabled)Q = P.symbol(p.symbol, -ua / 2 - ja, -4, p.options.marker.radius).attr(p.pointAttr[Ma]).attr({zIndex:3}).add(V);
                    p.legendSymbol = Q;
                    h(p, p.visible);
                    if (p.options && p.options.showCheckbox) {
                        p.checkbox =
                        Ea("input", {type:"checkbox",checked:p.selected,defaultChecked:p.selected}, E.itemCheckboxStyle, Aa);
                        kb(p.checkbox, "click", function(U) {
                            U = U.target;
                            za(p, "checkboxClick", {checked:U.checked}, function() {
                                p.select()
                            })
                        })
                    }
            ...
            function K() {
                ...
                S = t;
                M = jb = 0;
                V || (V = P.g("legend").attr({zIndex:7}).add());
                Db && hb.reverse();
                o(hb, function(U) {
                    if (U.options.showInLegend) {
                        U =
                        U.options.legendType == "point" ? U.data : [U];
                        o(U, J)
                    }
                });
                Db && hb.reverse();
                ...
                if (X || ab) {
                    nb += 2 * Ya;
                    Pa += 2 * Ya;
                    if (ha)ha.attr({height:Pa,width:nb}); else ha = P.rect(0, 0, nb, Pa, E.borderRadius, X || 0).attr({stroke:E.borderColor,"stroke-width":X || 0,fill:ab || fb}).add(V).shadow(E.shadow)
                }
                ...
                var N = Nc(R({width:nb,height:Pa}, E));
                V.translate(N.x, N.y);
                o(Ga, function(U) {
                    var Ba = U.checkbox;
                    Ba && Oa(Ba, {left:N.x + U.legendItemWidth + Ba.x - 40 + Ca,top:N.y + Ba.y - 11 + Ca})
                })
            }

            var E = m.options.legend;
            if (E.enabled) {
                var ma = E.layout == "horizontal",ua = E.symbolWidth,ja = E.symbolPadding,Ga = [],xa = E.style,ya = E.itemStyle,db = E.itemHoverStyle,Ha = E.itemHiddenStyle,Ya = parseInt(xa.padding, 10),rb = 20,ca = E.lineHeight || 16,t = 18,v = 4 + Ya + ua + ja,D,S,M,ha,X = E.borderWidth,ab = E.backgroundColor,V,jb,Xa = E.width,nb,Pa,hb = m.series,Db = E.reversed;
                K();
                return{colorizeItem:h,destroyItem:w,renderLegend:K}
            }
        };
        Sb = function(m, h) {
            var r = 0,w = 0;
        ...
        dd = function() {
            za(x, "selection", {resetSelection:true}, Gc);
        ...
        Nc = function(m) {
            var h = m.align,r = m.verticalAlign,w = m.x || 0,J = m.y || 0,K =
            {x:w || 0,y:J || 0};
            if (/^(right|center)$/.test(h))K.x = (Va - m.width) / {right:1,center:2}[h] + w;
            if (/^(bottom|middle)$/.test(r))K.y = (Fa - m.height) / {bottom:1,middle:2}[r] + J;
            return K
        };
        mc = tb = 0;
        kb(lb, "unload", ob);
    ...
    var ka = document,lb = window,Ka = Math,W = Ka.round,ib = Ka.floor,xc = Ka.ceil,ub = Ka.max,Mb = Ka.min,$a = Ka.abs,Jb = Ka.cos,Kb = Ka.sin,ra = navigator.userAgent,Zb = /msie/i.test(ra) &&
            ...
            Ib = sa.removeEvent,za = sa.fireEvent,Ub = sa.animate,nc = sa.stop;
    sa = sa.getAjax;
    var eb = {};
    if (!Da && lb.jQuery) {
        var Za = jQuery;
        ...
        Za.extend(Za.easing, {easeOutQuad:function(a, b, c, d, e) {
            return-d * (b /= e) * (b - 2) +
                  c
        }});
        var vd = jQuery.fx.step._default,wd = jQuery.fx.prototype.cur;
        ...
        kb = function(a, b, c) {
            if (typeof b == "string") {
                ...
                if (!a.addEvent)if (a.nodeName)a =
                                               $(a); else R(a, new Events);
                a.addEvent(b, c)
            }
        };
        Ib = function(a, b, c) {
        ...
        Ub = function(a, b, c) {
            ...
            nc(a);
            c = new Fx.Morph(d ? a : $(a), R(c, {transition:Fx.Transitions.Quad.easeInOut}));
            c.start(b);
            a.fx = c
        };
        nc = function(a) {
    ...
    Da = {enabled:true,align:"center",x:0,y:15,style:{color:"#666",fontSize:"11px"}};
    va = {colors:["#4572A7","#AA4643","#89A54E","#80699B","#3D96AE","#DB843D","#92A8CD","#A47D7C","#B5CA92"],symbols:["circle","diamond","square","triangle","triangle-down"],lang:{loading:"Loading...",months:["January","February","March","April","May","June","July","August","September","October","November","December"],weekdays:["Sunday","Monday","Tuesday",
        ...
        fontSize:"16px"}},subtitle:{text:"",x:0,y:40,align:"center",style:{color:"#6D869F"}},plotOptions:{line:{allowPointSelect:false,showCheckbox:false,animation:true,events:{},lineWidth:2,shadow:true,marker:{enabled:true,lineWidth:0,radius:4,lineColor:"#FFFFFF",states:{hover:{},select:{fillColor:"#FFFFFF",lineColor:"#000000",lineWidth:2}}},point:{events:{}},dataLabels:la(Da, {enabled:false,y:-6,formatter:function() {
        return this.y
    }}),showInLegend:true,states:{hover:{lineWidth:3,marker:{}},select:{marker:{}}},
        stickyTracking:true}},labels:{style:{position:Vb,color:"#3E576F"}},legend:{enabled:true,align:"center",layout:"horizontal",labelFormatter:function() {
        return this.name
        ...
        loading:{hideDuration:100,labelStyle:{fontWeight:"bold",position:bd,top:"1em"},showDuration:100,style:{position:Vb,backgroundColor:"white",opacity:0.5,textAlign:"center"}},tooltip:{enabled:true,formatter:function() {
            ...
            fontSize:"12px",padding:"5px",whiteSpace:"nowrap"}},toolbar:{itemStyle:{color:"#4572A7",cursor:"pointer"}},credits:{enabled:false,text:"Highcharts.com",href:"http://www.highcharts.com",style:{cursor:"pointer",color:"#909090",fontSize:"10px"}}};
    var hc = {dateTimeLabelFormats:{second:"%H:%M:%S",minute:"%H:%M",hour:"%H:%M",day:"%e. %b",week:"%e. %b",month:"%b '%y",year:"%Y"},endOnTick:false,gridLineColor:"#C0C0C0",labels:Da,lineColor:"#C0D0E0",lineWidth:1,max:null,min:null,minPadding:0.01,maxPadding:0.01,
        ...
        labels:{align:"right",x:-8,y:3},lineWidth:0,maxPadding:0.05,minPadding:0.05,startOnTick:true,tickWidth:0,title:{margin:40,rotation:270,text:"Y-values"}}),pd = {labels:{align:"right",x:-8,y:3},title:{rotation:270}},od = {labels:{align:"left",x:8,y:3},title:{rotation:90}},Yc = {labels:{align:"center",x:0,y:14},title:{rotation:0}},nd = la(Yc, {labels:{y:-5}});
    Da = va.plotOptions;
    sa = Da.line;
    Da.spline = la(sa);
    Da.scatter = la(sa, {lineWidth:0,states:{hover:{lineWidth:0}}});
    Da.area = la(sa, {});
    Da.areaspline = la(Da.area);
    Da.column = la(sa, {borderColor:"#FFFFFF",borderWidth:1,borderRadius:0,groupPadding:0.2,marker:null,pointPadding:0.1,minPointLength:0,states:{hover:{brightness:0.1,shadow:false},select:{color:"#C0C0C0",borderColor:"#000000",shadow:false}}});
    Da.bar = la(Da.column, {dataLabels:{align:"left",x:5,y:0}});
    Da.pie = la(sa, {borderColor:"#FFFFFF",borderWidth:1,center:["50%","50%"],colorByPoint:true,legendType:"point",marker:null,size:"90%",slicedOffset:10,states:{hover:{brightness:0.1,shadow:false}}});
    Pc();
    var Lb =
            function(a) {
                function b(j) {
    ...
    ic = function(a, b, c) {
        ...
        a = z(a, "%Y-%m-%d %H:%M:%S");
        b = new Date(b * cb);
        var e = b[tc](),f = b[uc](),g = b[Qb](),j = b[ac](),i = b[bc](),l = va.lang,n = l.weekdays;
        l = l.months;
        b = {a:n[f].substr(0, 3),A:n[f],d:d(g),e:g,b:l[j].substr(0, 3),B:l[j],
            m:d(j + 1),y:i.toString().substr(2, 2),Y:i,H:d(e),I:d(e % 12 || 12),l:e % 12 || 12,M:d(b[sc]()),p:e < 12 ? "AM" : "PM",P:e < 12 ? "am" : "pm",S:d(b.getSeconds())};
    ...
    ec.prototype = {init:function(a, b) {
        ...
        var c,d,e,f = this.element,g = f.nodeName,j = this.renderer,i,l = this.shadows,n,u = this;
        if (typeof a == "string" &&
            T(b)) {
            c = a;
            a = {};
        ...
        if (typeof a == "string") {
            ...
            } else if (c == "fill")b = j.color(b, f, c); else if (g == "circle")c = {x:"cx",y:"cy"}[c] || c; else if (c == "translateX" || c == "translateY") {
                this[c] =
                b;
        ...
        return this.attr({visibility:Xb})
    },hide:function() {
        return this.attr({visibility:zb})
    },add:function(a) {
        var b = this.renderer,c = a || b;
        b = c.element || b.box;
        var d = b.childNodes,e = this.element,f = oa(e, "zIndex"),g;
        ...
        if (a) {
            for (a = 1; a <= 3; a++) {
                c = d.cloneNode(0);
                oa(c, {isShadow:"true",stroke:"rgb(0, 0, 0)",
                    "stroke-opacity":0.05 * a,"stroke-width":7 - 2 * a,transform:"translate" + e,fill:fb});
    ...
    Wb.prototype = {init:function(a, b, c) {
        var d = ka.createElementNS("http://www.w3.org/2000/svg", "svg"),e = location;
        ...
        createElement:function(a) {
            ...
            o(b, function(j, i) {
                var l,n = 0;
                j = j.replace(/<span/g, "|||<span").replace(/<\/span>/g,
                        "</span>|||");
                l = j.split("|||");
                o(l, function(u) {
                    if (u !== "" || l.length == 1) {
                        var A = {},F = ka.createElementNS("http://www.w3.org/2000/svg", "tspan");
            ...
            g = typeof a == "object" ? a : {x:a,y:b,width:ub(c, 0),height:ub(d, 0)};
            return this.createElement("rect").attr(R(g, {rx:e || g.r,ry:e || g.r,fill:fb}))
        },g:function(a) {
            return this.createElement("g").attr(T(a) && {"class":Hb + a})
            ...
            if (g) {
                f = this.path(g);
                R(f, {symbolName:a,x:b,y:c,r:d});
                e && R(f, e)
            } else if (j.test(a)) {
                a = a.match(j)[1];
                f = this.image(a).attr({visibility:zb});
                Ea("img", {onload:function() {
                    var i = this;
                    i = ud[i.src] || [i.width,i.height];
                    f.attr({x:W(b - i[0] / 2) + Ca,y:W(c - i[1] / 2) + Ca,width:i[0],height:i[1],visibility:"inherit"})
                },src:a})
            ...
            return[bb,a,b - 1.33 * c,Ja,a +
                                        c,b + 0.67 * c,a - c,b + 0.67 * c,"Z"]
            ...
            var e = Math.PI,f = d.start,g = d.end - 1.0E-6,j = d.innerR,i = Jb(f),l = Kb(f),n = Jb(g);
            g = Kb(g);
            d = d.end - f < e ? 0 : 1;
            ...
            if (a && a.linearGradient) {
                ...
                c = a[b];
                var g = Hb + Lc++,j,i,l;
                j = f.createElement(b).attr({id:g,gradientUnits:"userSpaceOnUse",x1:c[0],y1:c[1],x2:c[2],y2:c[3]}).add(f.defs);
                o(a.stops, function(n) {
                    ...
                    f.createElement("stop").attr({offset:n[0],"stop-color":i,"stop-opacity":l}).add(j)
                });
            ...
            f = f || "left";
            e = e || 0;
            var g = d.color || "#000000",j = va.chart.style;
            b = W(z(b, 0));
            c = W(z(c, 0));
            R(d, {fontFamily:d.fontFamily || j.fontFamily,fontSize:d.fontSize || j.fontSize});
            d = qc(d);
            a = {x:b,y:c,text:a,fill:g,style:d.replace(/"/g, "'")};
            if (e || f != "left")a = R(a, {"text-anchor":{left:"start",center:"middle",right:"end"}[f],transform:"rotate(" + e + " " + b + " " + c + ")"});
            return this.createElement("text").attr(a)
        }};
    var Oc;
    if (!lc) {
        var xd = gb(ec, {init:function(a, b) {
            ...
            if (c) {
                c = a.style;
                Oa(d, {flip:"x",left:parseInt(c.width, 10) - 10,top:parseInt(c.height, 10) - 10,rotation:-90})
            }
            a.appendChild(d);
            return b
        },attr:function(a, b) {
            var c,d,e,f = this.element,g = f.style,j = f.nodeName,i = this.renderer,l = this.symbolName,n,u = this.shadows,A = ka.documentMode,F,qa = this;
            ...
            if (typeof a == "string") {
                c = a;
                qa = c == "strokeWidth" || c == "stroke-width" ? f.strokeweight : z(this[c], parseInt(g[{x:"left",y:"top"}[c] || c], 10))
            } else for (c in a) {
                d = a[c];
                F = false;
                if (l && /^(x|y|r|start|end|width|height|innerR)/.test(c)) {
                    ...
                    e = d.length;
                    for (F = []; e--;)F[e] =
                                      typeof d[e] == "number" ? W(d[e] * 10) - 5 : d[e] == "Z" ? "x" : d[e];
                    d = F.join(" ") || "x";
                    f.path = d;
                ...
                if (c == "text")f.innerHTML = d; else if (!F)if (A == 8)f[c] = d; else oa(f, c, d)
            }
            return qa
        },clip:function(a) {
            var b =
                    this,c = a.members,d = c.length;
            c.push(b);
            ...
            var b = [],c = this.element,d = this.renderer,e,f = c.style,g,j = c.path;
            if ("" + c.path == "")j = "x";
            if (a) {
                for (a = 1; a <= 3; a++) {
                    g = ['<shape isShadow="true" strokeweight="',7 - 2 * a,'" filled="false" path="',
                        j,'" coordsize="100,100" style="',c.style.cssText,'" />'];
                    e = Ea(d.prepVML(g), null, {left:parseInt(f.left, 10) + 1,top:parseInt(f.top, 10) + 1});
        ...
        Oc.prototype = la(Wb.prototype, {isIE8:ra.indexOf("MSIE 8.0") > -1,init:function(a, b, c) {
            this.width = b;
            this.height = c;
            this.box = Ea(Bb, null, {width:b + Ca,height:c + Ca}, a);
            this.Element =
            xd;
            ...
            return R(e, {members:[],element:{style:{left:a,top:b,width:c,height:d}},getCSS:function(f) {
                var g = e.element.style,j = g.top,i = g.left,l = i + g.width;
                g = j + g.height;
                j = {clip:"rect(" + (f ? i : j) + "px," + (f ? g : l) + "px," +
                          (f ? l : g) + "px," + (f ? j : i) + "px)"};
                !f && ka.documentMode == 8 && R(j, {width:l + Ca,height:g + Ca});
                return j
            ...
            var d,e = /^rgba/;
            if (a && a.linearGradient) {
                var f,g,j = a.linearGradient,i,l,n,u;
                ...
                c = ["<",c,' colors="0% ',i,",100% ",n,'" angle="',a,'" opacity="',
                    u,'" o:opacity2="',l,'" type="gradient" focus="100%" />'];
            ...
            if (c) {
                ...
                a = a.indexOf('style="') == -1 ? a.replace("/>", ' style="' +
                                                                 b + '" />') : a.replace('style="', 'style="' + b)
            ...
            f = f || "left";
            e = e || 0;
            var g = W(parseInt(d.fontSize || 12, 10) * 1.2),j = va.chart.style;
            b = W(b);
            c = W(c);
            R(d, {color:d.color || "#000000",whiteSpace:"nowrap",fontFamily:d.fontFamily || j.fontFamily,fontSize:d.fontSize || j.fontSize});
            if (e) {
                j = (e || 0) * Ka.PI * 2 / 360;
                e = Jb(j);
                j = Kb(j);
                var i = 10;
                g = g * 0.3;
                var l = f == "left",n = f == "right",u = l ? b : b - i * e;
                b = n ? b : b + i * e;
                l = l ? c : c - i * j;
                c = n ? c : c + i * j;
                u += g * j;
                ...
                if ($a(u -
                       b) < 0.1)u += 0.1;
                if ($a(l - c) < 0.1)l += 0.1;
                c = this.createElement("line").attr({from:u + ", " + l,to:b + ", " + c});
                e = c.element;
                Ea("hcv:fill", {on:true,color:d.color}, null, e);
                Ea("hcv:path", {textpathok:true}, null, e);
                ...
                if (f != "left") {
                    a = c.getBBox().width;
                    Oa(e, {left:b - a / {right:1,center:2}[f] +
                                Ca})
                }
            }
            return c
            ...
            var b;
            if (a)b = {className:Hb + a,"class":Hb + a};
    ...
    {init:function(a, b) {
        ...
        if (!this.hasImportedEvents) {
            var a = this,b = la(a.series.options.point,
                    a.options);
            b = b.events;
            var c;
            a.events = b;
        ...
        var b = this,c = b.series,d = c.options.states,e = c.options.marker,f = e && !e.enabled,g = (e = e && e.states[a]) && e.enabled === false,j = c.chart,i = b.pointAttr;
        a || (a = Ma);
        ...
        var a = this;
        a.tooltipText = a.series.chart.options.tooltip.formatter.call({series:a.series,point:a,x:a.category,y:a.y,percentage:a.percentage,total:a.total || a.stackTotal})
    }};
    var Ua = function() {
    };
    Ua.prototype = {isCartesian:true,type:"line",pointClass:Yb,pointAttrToOptions:{stroke:"lineColor","stroke-width":"lineWidth",fill:"fillColor",r:"radius"},init:function(a, b) {
        var c = this,d,e = a.series.length;
        c.chart = a;
        b = c.setOptions(b);
        R(c, {index:e,options:b,name:b.name ||
                                     "Series " + (e + 1),state:Ma,pointAttr:{},visible:b.visible !== false,selected:b.selected === true});
        a = b.events;
        ...
        for (b = a.length - 1; b >= 0; b--)a[b - 1] && a[b - 1].x == a[b].x && a.splice(b -
                                                                                        1, 1)
        ...
        var a = this.chart.options.symbols,b = this.options.marker.symbol || a[mc++];
        this.symbol =
        b;
        if (mc >= a.length)mc = 0
        ...
        var b = this,c = b.chart,d = c.inverted,e = [],f = (d ? c.plotTop : c.plotLeft) + c.plotSizeX,g,j,i = [];
        ...
        o(e, function(l, n) {
            ...
            for (j = l.high = e[n + 1] ? ib((l.plotX + (e[n + 1] ? e[n + 1].plotX : f)) / 2) : f; g <=
                                                                                                  j;)i[d ? f - g++ : g++] = l
        });
        b.tooltipPoints = i
    },onMouseOver:function() {
        ...
        var a = this,b,c = a.data,d = a.chart,e,f,g,j,i,l;
        if (a.options.marker.enabled)for (g = c.length; g--;) {
            ...
            if (f !== Na) {
                ...
                i = b.r;
                if (l)l.attr({x:e,y:f,r:i}); else j.graphic = d.renderer.symbol(z(j.marker && j.marker.symbol, a.symbol),
                        e, f, i).attr(b).add(a.group)
            }
        }
        ...
        var a = this,b = a.options.marker || a.options,c = b.states,d = c[pb],e,f = {},g = a.color,j = a.data,i = [],l,n = a.pointAttrToOptions;
        if (a.options.marker) {
            f = {stroke:g,fill:g};
        ...
        for (f = j.length; f--;) {
            ...
            if (e) {
                ...
                l[Ab] = a.convertAttribs(c[Ab],
                        i[Ab], l[Ma])
            } else l = i;
            g.pointAttr = l
        }
    },destroy:function() {
        var a = this,b = a.chart,c = b.series,d = a.clipRect,e;
        Ib(a);
        ...
        if (this.options.dataLabels.enabled) {
            var a = this,b,c,d = a.data,
                    e = a.options.dataLabels,f,g = a.dataLabelsGroup,j = a.chart,i = j.inverted,l = a.type,n,u;
            if (!g)g = a.dataLabelsGroup = j.renderer.g(Hb + "data-labels").attr({visibility:a.visible ? Xb : zb,zIndex:4}).translate(j.plotLeft, j.plotTop).add();
            n = e.color;
            if (n == "auto")n = null;
            e.style.color = z(n, a.color);
            o(d, function(A) {
                var F = z(A.barX, A.plotX),qa = A.plotY,L = A.tooltipPos,Z = A.dataLabel;
                if (Z)A.dataLabel = Z.destroy();
                f = e.formatter.call({x:A.x,y:A.y,series:a,point:A,percentage:A.percentage,total:A.total || A.stackTotal});
                b = (i ? j.plotWidth -
                         qa : F) + e.x;
                ...
                u = e.align;
                if (l == "column")b += {center:A.barW / 2,right:A.barW}[u] || 0;
                if (f)A.dataLabel = j.renderer.text(f, b, c, e.style, e.rotation, u).attr({zIndex:1,visibility:A.visible === false ? zb : "inherit"}).add(g);
                a.drawConnector && a.drawConnector(A)
            })
        }
    },drawGraph:function() {
        var a = this,b = a.options,c = a.chart,d = a.graph,e = [],f = a.area,g = a.group,j = b.lineColor || a.color,i = b.lineWidth,l,n = c.renderer,u = a.yAxis.getThreshold(b.threshold || 0),A = /^area/.test(a.type),F =
                [],qa = [];
        o(a.segments, function(L) {
            if (L.length > 1) {
                ...
                e = e.concat(l);
                if (A) {
                    var Z = [],Ia,sb = l.length;
                    for (Ia = 0; Ia < sb; Ia++)Z.push(l[Ia]);
                    if (b.stacking && a.type != "areaspline")for (Ia = L.length - 1; Ia >= 0; Ia--)Z.push(L[Ia].plotX, L[Ia].yBottom); else Z.push(L[L.length - 1].plotX, u, L[0].plotX, u, "z");
                    qa = qa.concat(Z)
                }
            } else F.push(L[0])
        });
        ...
        a.singlePoints = F;
        if (A) {
            c = z(b.fillColor, Lb(a.color).setOpacity(b.fillOpacity ||
                                                      0.75).get());
            if (f)f.attr({d:qa}); else a.area = a.chart.renderer.path(qa).attr({fill:c}).add(a.group)
        }
        if (d)d.attr({d:e}); else if (i)a.graph = n.path(e).attr({stroke:j,"stroke-width":i + Ca}).add(g).shadow(b.shadow)
    },render:function() {
        ...
        if (!a.group) {
            ...
            b.inverted && c.attr({width:b.plotWidth,
                height:b.plotHeight}).invert();
            c.clip(a.clipRect).attr({visibility:a.visible ? Xb : zb,zIndex:3}).translate(b.plotLeft, b.plotTop).add()
        }
        a.drawDataLabels();
        d && a.animate(true);
        a.getAttribs();
        ...
        var c = this,d = c.chart,e = c.legendItem,f = c.group,g = c.tracker,j = c.dataLabelsGroup,i,l = c.data,n = d.options.chart.ignoreHiddenSeries;
        i = c.visible;
        i = (c.visible = a = a === Na ? !i : a) ? "show" : "hide";
        if (a)c.isDirty = n;
        f && f[i]();
        if (g)g[i](); else for (f = l.length; f--;) {
            g = l[f];
            g.tracker && g.tracker[i]()
        }
        j && j[i]();
        e && d.legend.colorizeItem(c, a);
        n && c.options.stacking &&
        o(d.series, function(u) {
        ...
        var a = this,b = a.options,c = a.graphPath,d = a.chart,e = d.options.tooltip.snap,f = a.tracker,g = b.cursor;
        g = g && {cursor:g};
        var j = a.singlePoints,i,l;
        for (l = 0; l < j.length; l++) {
            i = j[l];
            c.push(bb, i.plotX - 3, i.plotY, Ja, i.plotX + 3, i.plotY)
        }
        if (f)f.attr({d:c}); else a.tracker = d.renderer.path(c).attr({isTracker:true,stroke:fd,fill:fb,"stroke-width":b.lineWidth + 2 * e,"stroke-linecap":"round",visibility:a.visible ? Xb : zb,zIndex:1}).on("mouseover", function() {
    ...
    ed.prototype = {get:function(a) {
        ...
        for (var b = this.n - 1,c = 0; b - c > 1;) {
            var d = (b + c) / 2;
            if (this.xdata[ib(d)] > a)b = d; else c = d
        }
        b = ib(b);
        c = ib(c);
    ...
    {type:"spline",drawGraph:function() {
        ...
        var a = this,b = a.chart,c = [],d = b.plotSizeX,e;
        o(a.segments, function(f) {
            ...
            c.push(f.length > 1 ? e ? (new ed(g)).get(e) :
                                  [] : f)
        });
        return c
    }});
    eb.spline = ra;
    ra = gb(ra, {type:"areaspline"});
    eb.areaspline = ra;
    var oc = gb(Ua, {type:"column",pointAttrToOptions:{stroke:"borderColor","stroke-width":"borderWidth",fill:"color",r:"borderRadius"},init:function() {
        ...
        var a = this,b = a.chart,c = 0,d = a.xAxis.reversed,e = a.xAxis.categories,f;
        Ua.prototype.translate.apply(a);
        o(b.series, function(L) {
            if (L.type ==
                a.type)if (L.options.stacking) {
                T(f) || (f = c++);
                L.columnIndex = f
        ...
        i = b - 2 * e;
        i = i / c;
        var l = g.pointWidth,n = T(l) ? (i - l) / 2 : i * g.pointPadding,u = z(l, i - 2 * n);
        l = (d ? c - a.columnIndex : a.columnIndex) || 0;
        var A = n + (e + l * i - b / 2) * (d ? -1 : 1),F = a.yAxis.getThreshold(g.threshold || 0),qa = g.minPointLength;
        o(j, function(L) {
            var Z = L.plotY,Ia = L.plotX + A,sb = xc(Mb(Z, F)),ob = u,Ta = xc($a((L.yBottom || F) -
                                                                                 Z)),H;
            if ($a(Ta) < (qa || 5)) {
                if (qa) {
                    Ta = qa;
            ...
            R(L, {barX:Ia,barY:sb,barW:ob,barH:Ta});
            L.shapeType = "rect";
            L.shapeArgs = {x:Ia,y:sb,width:ob,height:Ta,r:g.borderRadius};
            L.trackerArgs = T(H) && la(L.shapeArgs, {height:6,y:H})
        })
    },getSymbol:function() {
    },drawGraph:function() {
    },drawPoints:function() {
        ...
        o(a.data, function(f) {
            if (T(f.plotY)) {
                d = f.graphic;
                e = f.shapeArgs;
                if (d)d.attr(e); else f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? Ab : Ma]).add(a.group).shadow(b.shadow)
            }
        })
    },
        drawTracker:function() {
            ...
            o(a.data, function(l) {
                ...
                if (e)e.attr(d); else l.tracker = c[l.shapeType](d).attr({isTracker:f,fill:fd,visibility:a.visible ? Xb : zb,zIndex:1}).on("mouseover", function(n) {
    ...
    eb.scatter = ra;
    ra = gb(Yb, {init:function() {
        Yb.prototype.init.apply(this, arguments);
        var a = this,b;
        R(a, {visible:a.visible !== false,name:z(a.name, "Slice")});
        b = function() {
            a.slice()
        };
        kb(a, "select", b);
        ...
        var b = this,c = b.series.chart,d;
        d = (b.visible =
             a = a === Na ? !b.visible : a) ? "show" : "hide";
        b.group[d]();
    ...
    ra = gb(Ua, {type:"pie",isCartesian:false,pointClass:ra,pointAttrToOptions:{stroke:"borderColor","stroke-width":"borderWidth",fill:"color"},getColor:function() {
        this.initialColor =
        tb
    },translate:function() {
        var a = 0,b = this,c = -0.25,d = b.options,e = d.slicedOffset,f = d.center,g = b.chart,j = g.plotWidth,i = g.plotHeight,l,n,u;
        b = b.data;
        var A = 2 * Ka.PI,F,qa = Mb(j, i),L;
        ...
        o(b, function(Z) {
            ...
            n = c * A;
            Z.shapeType = "arc";
            Z.shapeArgs = {x:f[0],y:f[1],r:f[2] / 2,innerR:f[3] / 2,start:l,end:n};
            u = (n + l) / 2;
            Z.slicedTranslation = Gb([Jb(u) * e + g.plotLeft,Kb(u) * e + g.plotTop],
                    W);
        ...
        o(a.data, function(g) {
            ...
            if (!g.group) {
                ...
                g.group = c.g("point").attr({zIndex:3}).add().translate(d[0],
                        d[1])
            }
            if (e)e.attr(f); else g.graphic = c.arc(f).attr(g.pointAttr[Ma]).add(g.group);
            g.visible === false && g.setVisible(false)
        })
    },drawTracker:oc.prototype.drawTracker,getSymbol:function() {
    }});
    eb.pie = ra;
    lb.Highcharts = {Chart:kd,dateFormat:ic,getOptions:hd,numberFormat:id,Point:Yb,Renderer:cd,seriesTypes:eb,setOptions:gd,Series:Ua,addEvent:kb,createElement:Ea,discardElement:cc,css:Oa,each:o,extend:R,map:Gb,merge:la,pick:z,extendClass:gb}
})();
