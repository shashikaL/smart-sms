                ...
                <div id='dashboard-widgets' class='metabox-holder' style="width:550px">
                    <div id="dashboard_quick_press" class="postbox ">
                        ...
                        <div class="inside" style="margin:20px; max-height:400px;overflow:auto;">
                            <div> <br>
                                <p><font size="2" face="Verdana"><b></b></font> <br>
                                    <br>
                                </p>
                                <p><font size="2" face="Verdana"><b></b></font> <br>
                                </p>
                                ...
                                <br>
                                <p id="privacy"><font size="2" face="Verdana"><b></b></font> <br>
                                </p>
            ...
            <div class="metabox-holder" id="dashboard-widgets">
                <div class="postbox" id="dashboard_quick_press">
                            ...
                            <div>
                                <div class="input_row">
                                    <div class="input-text-wrap">
                                        <input id="appName" name="app.appName" type="text"/>
                                    </div>
                                </div>
                                ...
                                <div style="width:200px;margin-left:-50px" class="input_row"></div>
                    ...
                    <input onclick="location.href='appTypeSelection.html';" name="cancel" type="button" class="button" value="Back"/>
                      ...
                      <input onclick="location.href='votingAppConfirm.html';" name="Submit" type="button" class="button" value="Next" id="next"/>
                      </span></div>
                            </div>
                    </form>
                </div>
