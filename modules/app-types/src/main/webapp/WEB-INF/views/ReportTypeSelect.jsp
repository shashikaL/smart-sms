    ...
    <div id="header2">
        ...
        <div id="body">
            <div class="sub_heading">
                <h1>View Application Reports</h1>
            </div>
                ...
                <div id="dashboard-widgets-wrap">
                    <div class="metabox-holder" id="dashboard-widgets">
                        <div class="postbox" id="dashboard_quick_press">
                            <h3 class="hndle"><span>Select Report Type </span></h3>
                            <div class="inside">
                                <form action="" id="quick-press" name="post">
                                    ...
                                    <div style="width:50%;float:left;">
                                        ...
                                        <div id="home_image">
                                            ...
                                            <div style="padding-right:5px" class="app_text">
                                                <div style="padding-bottom:10px; padding-top:15px" class="bold_text">Voting Reports</div>
                                                <div class="normal_text">Voting Application Reports</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="home_image">
                                            ...
                                            <div class="app_text">
                                                <div style="padding-bottom:10px; padding-top:15px" class="bold_text">Services Reports</div>
                                                <div class="normal_text">Service Application Reports</div>
                                            </div>
                                        </div>
                                    ...
                                    <div style="width:50%;float:left;">
                                        ...
                                        <div id="home_image">
                                            ...
                                            <div class="app_text">
                                                <div style="padding-bottom:10px; padding-top:15px" class="bold_text">Alert Reports</div>
                                                <div class="normal_text">Alert Application Reports</div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="home_image">
                                            ...
                                            <div class="app_text">
                                                <div style="padding-bottom:10px; padding-top:15px" class="bold_text">Contact Reports</div>
                                                <div class="normal_text">Contact Application Reports</div>
                                            </div>
                                        </div>
