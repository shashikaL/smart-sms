                        ...
                        <div class="items">
                            <div style="float:left;margin-right:5px;" class="item2">
                                ...
                                <c:forEach var="app" items="${alertApps}">
                                    <div style="float:left;margin-right:5px;" class="item">
                                        <div class="my_app">
                                            <div class="sub_image"><img height="75" onclick="window.location='AlertUse?username=<c:out value="${app.userID}"/>&appId=<c:out value="${app.appId}"/>'" onMouseout="hidetooltip()" width="75" class="clickImg" onMouseover="showTip('<b><u>Alert Application</u></b><br/> ')" src="resources/images/alert_app.jpg"/></div>
                                            <div style="float:left;line-height:25px;">
                                                <div style="width:80px;">
